# alliance-phenotype-association-ingest

| [Documentation](https://monarch-initiative.github.io/alliance-phenotype-association-ingest) |

KGX transform of all Alliance of Genome Resoures phenotype associations
...
```bash
cd alliance-phenotype-association-ingest
make install
make test
```
...
Download the data for the alliance_phenotype_association_ingest transform:

```bash
poetry run alliance_phenotype_association_ingest download
```

To run the Koza transform for alliance-phenotype-association-ingest:

```bash
poetry run alliance_phenotype_association_ingest transform
```

To see available options:

```bash
poetry run alliance_phenotype_association_ingest download --help
# or
poetry run alliance_phenotype_association_ingest transform --help
```
